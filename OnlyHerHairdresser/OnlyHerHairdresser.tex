...
\marginpar{\includegraphics{OnlyHerHairdresser/fiber-optic-pixie-princess-skirtQR.png}}
\item \textit{Adafruit Color Sensors} at 
\url{https://learn.adafruit.com/adafruit-color-sensors} 
\marginpar{\includegraphics{OnlyHerHairdresser/adafruit-color-sensorsQR.png}}
\end{itemize}
